...
//  -> documnet.querySelectorAll() -> it will make an array of all who have that class/id..
...
// 3. Apperance(styling) -> element.style.css_property(css:background-url -> js: backgroundUrl= Propert_value(string)
                    ...
                    //  -> element_name.style.object_name[key] = object_name[key]
                    // -> element_name.style + "." + key + "=" + object_name[key]
...
// 7. Methods -> 1. Random()-> range: 0 to 0.9  -> manually range increase -> Math.random() * max_range+1 // we have to add 0 because if the range is zero then atleast we have 1.
...
// 10. Array method -> 1. map -> entire elemnt store in array -> same operation -> result store in new array.., array size = original array size
